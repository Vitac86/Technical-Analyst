...
const STRINGS: Record<Lang, Dict> = {
  ru: {
    ...
    "drawer.search.bcsFallback": "Используется офлайн-список BCS GOODS",
    "drawer.search.section.bcsGoods": "Товары BCS",
    "drawer.search.section.moex": "MOEX",
    "drawer.add": "+ Добавить",
  ...
  en: {
    ...
    "drawer.search.bcsFallback": "Using offline BCS GOODS list",
    "drawer.search.section.bcsGoods": "BCS GOODS",
    "drawer.search.section.moex": "MOEX",
    "drawer.add": "+ Add",
